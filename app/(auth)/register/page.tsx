    ...
    <main className="flex min-h-screen flex-col items-center justify-center p-6 bg-slate-900 text-slate-50">
      <div className="max-w-md w-full glass-card p-8 rounded-2xl">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400">Mulai kelola keuanganmu dengan AI</p>
        </div>
        ...
        <p className="text-center text-sm text-slate-400 mt-6">
          Sudah punya akun? <Link href="/login" className="text-blue-400 hover:underline font-medium">Masuk</Link>
        </p>
      </div>
    </main>
  );
